...
void piesa_I(){
    ...
    pbmp->bmp_infoheader.width = 30;
    pbmp->bmp_infoheader.height = 60;
    ...
    sizeof(bmp);
    FILE *fp = fopen("piesa_I.bmp","wb");
    FILE *fp180 = fopen("piesa_I_180.bmp","wb");
    ...
    pbmp90->bmp_infoheader.width = 60;
    pbmp90->bmp_infoheader.height = 30;
    ...
    sizeof(bmp);
    FILE *fp90 = fopen("piesa_I_90.bmp","wb");
    FILE *fp270 = fopen("piesa_I_270.bmp","wb");
