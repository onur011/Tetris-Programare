	...
	if(rotatie == 0){
		for(i = 0; i < H + 40 ; i++){
			for(j = coloana; j< (L + bitiextra); j++){
				...
				(imagine[H + 40 - 1 - i][j] != 1) && (j >= coloana)
				&& (j < coloana + 20)){
					c = H + 40 - i;
					c=c/10*10;
					c=H+40-c;
		...
		for(i = 0; i < (H + 40)-c; i++){
			for(j = coloana; j< (L + bitiextra); j++){
				...
				if((i >= 0) && (i < 10) && (j<coloana+20)){
					imagine[H + 40 - 1 - c - i][j]=3;
				}
	...
	if(rotatie == 180){
		...
		for(i = 0; i < (H + 40)-c; i++){
			for(j = coloana; j< (L + bitiextra); j++){
				...
				if((i >= 0) && (i < 20) && 
				(j < coloana + 20) && (j >= coloana + 10)){
					imagine[H + 40 - 1 - c - i][j]=3;
				}
				if((i >= 20) && (i < 30) && (j<coloana+20)){
					imagine[H + 40 - 1 - c - i][j]=3;
				}
			}
		}
	...
	if(rotatie == 270){
		...
		for(i = 0; i < (H + 40)-c; i++){
			for(j = coloana; j< (L + bitiextra); j++){
				...
				if((i >= 0) && (i < 10) &&
				(j < coloana + 30) && (j >= coloana)){
					imagine[H + 40 - 1 - c - i][j]=3;
				}
				if((i >= 10) && (i < 20) &&
				(j < coloana + 30) && (j >= coloana + 20)){
					imagine[H + 40 - 1 - c - i][j]=3;
				}
			}
		}	
